    ...
    return Scaffold(
      ...
      body: _selectedImage == null
        ...
        child: GestureDetector(
          onTapUp: (details) {
            setState(() {
              // Capture localPosition relative to the image
              points.add(details.localPosition); // Add the tapped position
              controlPoints.add(null); // Add a control point placeholder

              // Check if two points are selected and measure the curve
